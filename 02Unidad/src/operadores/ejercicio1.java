...
public class ejercicio1 {
	...
	public static void main(String[] args) {
		...
		//Raiz 4.5-5.0   + 7 * 3
		System.out.println("diez - El resultado es: " + (Math.sqrt(4.5-5.0) + 7 * 3));
		
		//3*10/3 + 10% 3 (resto de dividir 10/3)
		...
		//(36.0/4) + (5*3)
		System.out.println("doce - El resultado es: " + ((36.0/4) + (5*3)));
		...
		//2^3^3
		System.out.println("quince - El resultado es: " + (Math.pow(2, Math.pow(3, 3))));
