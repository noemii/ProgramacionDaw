...
public class euribor {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		//2009
		crearRectangulo(80,180,30,350, new Color (141,217,255));//4.1  (x,y,an,al)
	...
	private static void crearRectangulo(int x, int y, int w, int h, Color color) throws InterruptedException {
		...
		for(int a=1;a<=pasos;a++){
			...
			int altoColumna = h/pasos * a;
			int inicioColumna = h - altoColumna + y;
			Rectangle rectangulo;
			rectangulo = new Rectangle(x,inicioColumna,w,altoColumna); //x,y ancho, alto
			rectangulo.draw();
			rectangulo.setColor(color);
			rectangulo.fill();
		}
